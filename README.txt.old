...
http://foundation.zurb.com/docs/faq.php or use the script in the foundation
...
----------------------------------
 1. Setup the location for your new sub-theme.
    ...
    Copy the foundation folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the sites/all/themes/zurb_foundation/foundation folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the foundationKIT.info.txt file to include
    the name of your new sub-theme and remove the ".txt" extension. Then edit
    the .info file by editing the name and description field.

    For example, rename the foo/foundation.info.txt file to foo/foo.info. Edit the
    foo.info file and change "name = Foundation Sub-theme foundation" to
 ...
 3. Edit your sub-theme to use the proper function names.
    ...
    folder; replace ALL occurrences of "foundation" with the name of your
    sub-theme.

    For example, edit foo/template.php and foo/theme-settings.php and replace
    every occurrence of "foundation" with "foo".
